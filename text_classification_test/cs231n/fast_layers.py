...
try:
    from text_classification_test.cs231n import col2im_cython, im2col_cython
    from text_classification_test.cs231n import col2im_6d_cython
except ImportError:
    print('run the following from the cs231n directory and try again:')
    print('python setup.py build_ext --inplace')
    print('You may also need to restart your iPython kernel')

from text_classification_test.cs231n.im2col import *
